...
//Création d'une nouvelle connexion en tant que root
$conn=new mysqli('localhost', 'root', '');
//Connexion vers la nouvelle base contenant la table des commandes
SimpleOrm::useConnection($conn, 'coffrefort');